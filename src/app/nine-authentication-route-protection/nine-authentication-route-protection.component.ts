...
@Component({
  ...
  template: `
    ...
    <h2><mark>Authentication & Route Protection - 1 Project.</mark></h2>
    <section class="container-fluid">
      <div class="row mt-4 pt-4 d-flex justify-content-around">
        <div class="lessonbox col-md-6 col-lg-5 col-xxl-3">
        ...
        <a class="btn btn-primary rounded-1 me-3" href="https://ng-course-food-application.firebaseapp.com/auth" target="_blank">
        ...
        <a class="btn btn-success rounded-1" href="https://github.com/nickpolizogopoulos/food-recipes-app" target="_blank">
